	...
	<body>
		...
		<div class="container">
			...
			<div class="formulario">
				<form name="frmReporteCliente" method="get" action="ReporteCuentasVencidasImprimir.php">
					<table align='center'>
						<tr>
							<td>	
								<label>Fecha Saldo Vencido:</label>
							</td>
							<td>
								<input  name="txtFechaSaldoVencido" type="date" value="<?php echo date('Y-m-d', strtotime($FechaSaldoVencido));  ?>" required>
							</td>	
						</tr>
						<tr>
							<td>
