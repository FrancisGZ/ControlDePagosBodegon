	...
	<body>
		...
		<div class="container">
			...
			<div class="formulario">
				<form method="get" name="frmReportePago" action="ReportePagosPretarjetaImprimir.php">
					<table align="center">
						<!--<tr>
							<td>	
					...
					<table>
						...
						<?php
								...
								/*$query="select a.IdCliente,a.NombreCliente,b.IdFactura,c.MontoPago as Pagos,
									...
									$query="select a.NombreCliente,c.MontoPago as Pagos,
									c.FechaPago as FechaUltimoPago, a.Ruta, c.IdPago, c.TipoPago, c.TipoDocumento
							...
							{
								echo "<div align='center'>La pretarjeta no tiene pagos</div>";
							}

							echo "<div align='center'>

									<a href='AplicarPagoPretarjetaAccion.php?txtNumeroDePretarjeta=$NumeroDePretarjeta&btnAccion=Buscar Pretarjeta'>Regresar</a>
